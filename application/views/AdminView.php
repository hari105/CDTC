        ...
        <div class="col-md-9 register-right">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <?php echo $this->session->flashdata('adminLoginSuccess'); ?>
                    

                    <?php echo $this->session->flashdata('adminLoginFailed'); ?>
                        ...
                        <div class="col-md-12">
                            <form action="Admin/adminLogin" method="POST">
                                ...
                                <div style="float: left;color: #5F9EA0;font-size: 14px;margin-left: 8%;">
                                    <a href="<?php echo site_url('Auth/login') ?>">Login as Student</a>
