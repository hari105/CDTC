...
<div class="container course rounded">
    ...
    <br>
        ...
        <ul style="list-style-type:square; " >
            <li>Understand different types of communication protocols</li>
            <li>Learn hardware setup for IoT Application</li>
        </ul>
<br>

        <h2>Outcome:</h2>
        <ul style="list-style-type:square; " >
            <li>Students will be able to design and develop IoT applications.</li>
...
<br>
    ...
    <h2>Course Content:</h2>
             <ul style="list-style-type:square; " >
            <li><b>Communication protocols & IOT Platforms</b> : Types of
